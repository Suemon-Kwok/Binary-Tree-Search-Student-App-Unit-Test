...
public class StudentApp {
    ...
    public static void main(String[] args){
        ...
        {
            nameIndexList[0] = nameIndexList[1];
            nameIndexList[1] = 1;
        }
        
        if(nameIndexList[0] == 10)
        {
            nameIndexList[0] = nameIndexList[1];
            nameIndexList[1] = 10;
        }
        ...
        for(int i = 0; i < dataSize; i++)
        {
            ...
            studentManager.addStudent("Student"+(nameIndexList[i]<10?"0"+nameIndexList[i]:nameIndexList[i]), score, "Comments "+i);
        ...
        mark+=checkSortByNameAfterReverse(studentList, studentManager);
        System.out.println("*****************************************\nCurrent mark: "+mark);
    ...
    public static int checkSortByNameAfterReverse(Student[] list, StudentManager manager)
    {
        int mark = 0;
        for(int i = 0; i < list.length-1; i++)
        {
        ...
        if(   manager.bTreeName.root.l_node.compareTo(manager.bTreeName.root) < 0
           && manager.bTreeName.root.r_node.compareTo(manager.bTreeName.root) > 0)
        {
            return 0;
        }
